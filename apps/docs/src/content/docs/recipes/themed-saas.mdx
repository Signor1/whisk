...
description: A worked rebrand where earth-tone defaults swapped for corporate navy and teal, with one CSS rule.
---
...
Import the override _after_ Whisk's styles so it wins on cascade:
